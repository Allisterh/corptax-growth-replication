...
#Load data
dat <- fread(here("Data-EER-RR2.csv"))
...
#mean_SC <- aggregate(dat$CorrelationCoefficientCorrected, list(dat$Authors), FUN=mean, na.rm=TRUE) 
#write.csv(mean_SC, "mean_SC.csv")
